...
import { PaymentCompanyOutput } from "./../../output/payment-company-output";

export class PaymentCompany extends Model {
  /**
   * Collection name
   */
  public static collection = "paymentCompanies";

  /**
   * Output class
   */
  public static output = PaymentCompanyOutput;
   ...
   */
  public syncWith: ModelSync[] = [EPayment.sync("paymentCompany")];
   ...
   */
  public embedded = ["id", "name", "supplier"];
}
