...
import { EPaymentsCompanyHistoryItem } from "app/e-payments-company-history-items/models/e-payments-company-history-item";
import { EPaymentOutput } from "./../../output/e-payment-output";

export class EPayment extends Model {
  /**
   * Collection name
   */
  public static collection = "ePayments";

  /**
   * Output class
   */
  public static output = EPaymentOutput;
  ...
  protected casts: Casts = {
    ePaymentsCompanyHistoryItems: EPaymentsCompanyHistoryItem,
    date: "date",
    total: "number",
  };
